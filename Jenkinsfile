node {
  ...
  stage('SonarQube Analysis') {
    ...
    withSonarQubeEnv() {
      bat "\"${scannerHome}\\SonarScanner.MSBuild.exe\" begin /k:\"aravinddsrc_Sonar_Branch\" /d:sonar.login=d37f7b8be381afc0e2100252e2e293dcdaecdbdb /d:sonar.branch.name=$BRANCH_NAME"   
